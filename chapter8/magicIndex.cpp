...
int magicIndex_nodup_helper(const vector<int>& arr, const int& begin, const int& end)
{
	if (begin > end)
	{
		return -1;
...
int magicIndex_helper(const vector<int>& arr, const int& begin, const int& end)
{
	if (begin > end)
	{
		return -1;
