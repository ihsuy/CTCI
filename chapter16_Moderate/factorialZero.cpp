...
int factorialZero(const int& n) {  // trailing zeros are produced by
...
int factorialZero_optimal(
    int n) {  // directly counting the appearance of multiple of 5s
...
int main() {
    ...
    for (int n = 2; n <= N; ++n) {
        ...
        cout << n << " method1: factorial contains " << res1
             << " trailing zeros.\n";
        cout << n << " method2: factorial contains " << res2
             << " trailing zeros.\n";
        if (res1 != res2) {
