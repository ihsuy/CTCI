...
A value of zero indicates water. A pond is a region of water connected vertically,
horizontally, or diagonally. The size of the pond is the total number of connected
			...
			if (land[r][c] == 0)
			{
				...
				while (not todo.empty())
				{
					...
					{	// 8 directions
						...
						if (cur_r >= 0 and cur_c >= 0 and
						        cur_r < landr and cur_c < landc and
						        land[cur_r][cur_c] == 0)
						{
