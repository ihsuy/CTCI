...
Assume that the top and the bottom sides of the square run parallel to the
x-axis.
*/
...
string bisectSquares(const square& sq1,
                     const square& sq2) {  // to find a line that cuts two
                                           // different sqaure into half
