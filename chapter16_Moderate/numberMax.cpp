...
int numberMax(int a, int b)
{
	...
	auto a_sign = signBit(a); // 0 if positive 1 if negative (kinda confusing here)
	...
	// 			b_sign*a + a_sign*b
	return (!sign_diff)*((!diff_sign)*a + diff_sign*b) + sign_diff*(b_sign*a + a_sign*b);
}
