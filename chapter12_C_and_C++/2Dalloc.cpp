...
int** array2D_sepBlocks(
    const int& r,
    const int& c) {  // allocate different memory blocks for each row
...
int** array2D_oneBlock(
    const int& r,
    const int& c) {  // allocate the hole 2d array in one memory block
